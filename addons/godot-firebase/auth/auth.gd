...
func signup_with_email_and_password(email : String, password : String) -> void:
	if _is_ready():
		...
		request(_signup_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_login_request_body))
...
func login_anonymous() -> void:
	if _is_ready():
		is_busy = true
		request(_signup_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_anonymous_login_request_body))
...
func login_with_email_and_password(email : String, password : String) -> void:
	if _is_ready():
		...
		_login_request_body.email = email
		_login_request_body.password = password
		request(_signin_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_login_request_body))
...
func login_with_oauth(google_token: String, provider_id : String = "google.com", request_uri : String = "http://localhost") -> void:
	...
	if is_successful and _is_ready():
		...
		request(_signin_with_oauth_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_oauth_login_request_body))
...
func manual_token_refresh(auth_data):
	...
	request(_refresh_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_refresh_request_body))
...
func change_user_email(email : String) -> void:
	if _is_ready():
		...
		request(_update_account_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_change_email_body))
...
func change_user_password(password : String) -> void:
	if _is_ready():
		...
		request(_update_account_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_change_password_body))
...
func update_account(idToken : String, displayName : String, photoUrl : String, deleteAttribute : PackedStringArray, returnSecureToken : bool) -> void:
	if _is_ready():
		...
		request(_update_account_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_update_profile_body))
...
func send_account_verification_email() -> void:
	if _is_ready():
		...
		request(_oobcode_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_account_verification_body))
...
func send_password_reset_email(email : String) -> void:
	if _is_ready():
		...
		request(_oobcode_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify(_password_reset_body))
...
func get_user_data() -> void:
	if _is_ready():
		...
		request(_userdata_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify({"idToken":auth.idtoken}))
...
func delete_user_account() -> void:
	if _is_ready():
		is_busy = true
		request(_delete_account_request_url, _headers, true, HTTPClient.METHOD_POST, JSON.stringify({"idToken":auth.idtoken}))
